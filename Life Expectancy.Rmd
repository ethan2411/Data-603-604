...
7.  Adding higher powers and using partial F-test to confirm the hgher power model is significiant
...
### TESTING FIT MODEL WITHOUT 3P OUTLIERS make new model then reduce
