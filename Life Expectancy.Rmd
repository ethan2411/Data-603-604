...
bcmodel = lm((((Life.expectancy^bestlambda)-1)/bestlambda) ~  Alcohol + Hepatitis.B  + Measles + BMI + Polio + Diphtheria + HIV.AIDS, data = developing_LE)
summary(bcmodel)

bcmodelred = lm((((Life.expectancy^bestlambda)-1)/bestlambda) ~  Alcohol + Hepatitis.B + BMI + Polio + Diphtheria + HIV.AIDS, data = developing_LE)
summary(bcmodelred)

bcmodelint = lm((((Life.expectancy^bestlambda)-1)/bestlambda) ~  (Alcohol + Hepatitis.B  + Measles + BMI + Polio + Diphtheria + HIV.AIDS)^2, data = developing_LE)

stepbcmodel = ols_step_both
```
